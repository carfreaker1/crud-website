...
<!-- -->
 ...
 <form action="update_middle_menu.php" method="post" enctype="multipart/form-data" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>>
            <div class="mt-3">
            <div class="bg-dark py-3">
        <div class="container">
            <div class="h4 text-white">Edit Middle Menu</div>
        </div>
    </div>
</div>
            <div>
               <input type="hidden" name="id" value="<?php echo $menus['id']; ?>">
                ...
                <input type="text" class="form-control" id="name" value="<?php echo $menus['name']; ?>" name="name" aria-describedby="emailHelp"
            ...
            <div class="mt-3">
                ...
                <input type="text" class="form-control" id="url" value="<?php echo $menus['url']?>" name="url" aria-describedby="emailHelp"
                    pattern="{1,255}" placeholder="Enter Your Middle Menu URL" required>
            ...
            <div class="mt-3">
                    <input type="hidden" name="old_image" class="form-control" id="image"
                        value="<?php echo $menus['image']; ?>">
                    Select image to
                    upload:
                    <input type="file" name="image" class="form-control" id="image"
                        value="<?php echo $menus['image']; ?>">
                </div>
                <img style="width:50px" src="../upload/<?php echo $menus['image']; ?>">
