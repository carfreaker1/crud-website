        ...
        <tbody>
            ...
            while ($data = mysqli_fetch_array($middle_menu)) {
                ...
                <tr>
                   ...
                   <td>
                       <img style="width:50px": src="../upload/<?php echo $data['image'];?>" alt=""> 
                    </td>
                    <td>
                        <a class='btn btn-sm btn-primary mb-3'
                            href="../middle_menu/edit_middle_menu.php?id=<?php echo urlencode(openssl_encrypt($data['id'], 'AES-128-ECB', 'your_secret_key')); ?>">Edit</a>

                        <a class='btn btn-sm btn-primary' href="../middle_menu/delete_middle_menu.php?id=<?php echo urlencode(openssl_encrypt($data['id'], 'AES-128-ECB', 'your_secret_key')); ?>"
