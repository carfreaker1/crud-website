...
<form action="middle_menu_insert.php" method="post" enctype="multipart/form-data" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>>
        <div class="mt-3">
            <div class="bg-dark py-3">
               <div class="container">
              <div class="h4 text-white">Create Middle Menu</div>
            </div>
        </div>
            ...
            <div>
                ...
                <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp"
                    pattern="[A-Z a-z\s]{3,30}" placeholder="Enter Your Middle Menu Name" required>
            </div>
            ...
            <div class="mt-3">
                ...
                <button type="submit" onclick="return confirm('Your Are Now Going On to The Listing Page.')"
                    class="btn btn-primary mb-3" name="submit" >Submit</button>
        </form>
