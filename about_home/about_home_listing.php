                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-sm btn-primary mb-3'
                            href="../about_home/edit_about_home.php?id=<?php echo $about_home['id']; ?>">Edit</a>

                        <a class='btn btn-sm btn-primary' href="../about_home/delete_about_home.php?id=<?php echo $about_home['id']; ?>"
