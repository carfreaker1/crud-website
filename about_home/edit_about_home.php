...
$id = $_GET['id'];
$about_home = mysqli_query($conn, "SELECT * FROM `about_home` WHERE id=" . $id . "");
$about_homes = mysqli_fetch_assoc($about_home);
// print_r($about_homes);
// die;
?>
...
<?php
    ...
    <form action="about_home_insert.php" method="post" enctype="multipart/form-data" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>>
        ...
        <div class="mr-3">
            ...
            <input type="textarea" class="form-control" value="<?php echo $about_homes['about']?>" name="about" aria-describedby="emailHelp" pattern="{3,255}" placeholder="Enter About Home" required>
        </div>            
