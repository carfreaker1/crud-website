...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" sizes="180x180" type="image/x-icon" href="upload/apple-touch-icon.webp">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            ...
            <p>LUGX Gaming is free Bootstrap 5 HTML CSS website template for your gaming websites. You can download and use this layout for commercial purposes. Please tell your friends about TemplateMo.</p> -->
             ...
             <?php
                $about_home = mysqli_query($conn,"SELECT * FROM `about_home`");
                while ($about = mysqli_fetch_assoc($about_home)) {
                  // print_r($about);die ;
                  // print_r($about['about_home']);
                  // die;
                echo  "$about[about]";
              }
            ?> 
        ...
        <div class="col-lg-4 offset-lg-2">
          <div class="right-image banner-img-size">
    ...
    <div class="container">
      <div class="row">
        <?php
                ...
                while ($middle_menus = mysqli_fetch_assoc($middle_menu)) {
                  // print_r($middle_menus);die ;
              ?>
        <div class="col-lg-3 col-md-6">

           <a href="<?php echo $middle_menus['url'] ?>">
             <div class="item">
               <div class="image">
                 <img src="upload/<?php echo $middle_menus['image']?>" alt="" style="max-width: 44px;">
               </div>
               <h4><?php echo $middle_menus['name']  ?></h4>
             </div>
           </a>  
           </div> 
       <?php } ?>
<!--        
        ...
        <div class="col-lg-3 col-md-6">
          <a href="#">
            <div class="item">
              <div class="image">
                <img src="assets/images/featured-03.png" alt="" style="max-width: 44p x;">
              </div>
              <h4>Reply Ready</h4>
            </div>
          </a>
  ...
  <div class="section trending" id="trendingGames">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
        ...
        <?php
                $trendingGames = mysqli_query($conn, "SELECT game_content.id, game_content.name, game_content.our_price, game_content.game_place, game_content.discount_price, game_content.image, game_category.category_name FROM game_content LEFT JOIN game_category ON game_content.category = game_category.id WHERE game_Place = 'TRENDING' LIMIT 0,4;");
              ...
              <div class="item">
              <a href="product-details.php?id='.$encyptID = urlencode(openssl_encrypt($games['id'], 'AES-128-ECB', 'your_secret_key')).'">
                <div class="thumb">
                 <img src="upload/'.$games['image'].'" alt="">
                  <span class="price"><em>'.$games['discount_price'].'</em>'.$games['our_price'].'</span>
                </div>
                <div class="down-content">
                  <span class="category">'.$games['category_name'].'</span>
                  <h4>'.$games['name'].'</h4>
  ...
  <div class="section most-played" id="mostPlayed">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="section-heading">
        ...
        <div class="col-lg-6">
         ...
         <?php          
              $trendingGames = mysqli_query($conn, "SELECT game_content.id, game_content.name, game_content.our_price, game_content.game_place, game_content.genre,game_content.discount_price, game_content.image, game_category.category_name FROM game_content LEFT JOIN game_category ON game_content.category = game_category.id WHERE game_place = 'TOP_GAMES' LIMIT 0,6;");
              ...
              foreach($trendingGames as $games){  
                //  print_r($games);
                 ...
                 <div class="item">
                   <div class="thumb">
                     <a href="product-details.php?id='.$encyptID = urlencode(openssl_encrypt($games['id'], 'AES-128-ECB', 'your_secret_key')).'"><img src="upload/'.$games['image'].'" alt=""></a>
                   </div>
                   <div class="down-content">
                       <span class="category">'.$games['category_name'].'</span>
                       <h4>'.$games['genre'].'</h4>
                       <a href="product-details.php?id='.$encyptID = urlencode(openssl_encrypt($games['id'], 'AES-128-ECB', 'your_secret_key')).'">Explore</a>
                   </div>
                 </div>
               </div>';
  ...
  <div class="section categories" id="topCategories">
    <div class="container">
      <div class="row">
        ...
        <?php
              $trendingGames = mysqli_query($conn, "SELECT game_content.id, game_content.name, game_content.our_price, game_content.game_place, game_content.genre, game_content.image, game_category.category_name FROM game_content LEFT JOIN game_category ON game_content.category = game_category.id WHERE game_place = 'CATEGORIES'LIMIT 0,5;");
                    // print_r($trendingGames);
                    // die;
                    foreach($trendingGames as $games){  
                      // print_r($games);
