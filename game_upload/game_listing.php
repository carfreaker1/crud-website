...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f09433', endColorstr='#bc1888',GradientType=1 );"class="text-white">Your Submitted Forms</h2>
    <table id="example" class="display" style="width:100%">
        ...
        <tbody>
            <?php
                $games = mysqli_query($conn, "SELECT game_content.id, game_content.name, game_content.our_price,game_content.game_place, game_content.multitags, game_content.image, game_category.category_name FROM game_content LEFT JOIN game_category ON game_content.category = game_category.id;");
                $sno = 0;
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php echo $game['our_price']; ?>
                    </td>
                    <td>
                        <?php echo $game['game_place']; ?>
                    </td>
                    <td>
                        <?php echo $game['category_name']; ?>
                    </td>
                    <td>
                        <?php echo $game['multitags']; ?>
                    </td>
                    <td>
                    <img style="width:50px": src="../upload/<?php echo $game['image']; ?>" alt=""> 
                    </td>
                    ...
                    <td>
                        <a class='btn btn-sm btn-primary mb-3'
                            href="../game_upload/edit_game.php?id=<?php echo urlencode(openssl_encrypt($game['id'], 'AES-128-ECB', 'your_secret_key')); ?>">Edit</a>

                        <a class='btn btn-sm btn-primary' href="../game_upload/delete_game.php?id=<?php echo urlencode(openssl_encrypt($game['id'], 'AES-128-ECB', 'your_secret_key')); ?>"
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f09433', endColorstr='#bc1888',GradientType=1 );">
        <strong><a class="text-white"  
                href="create_game.php" style="display: flex; justify-content : center">Click Here
                to
                Submit
                New Form
            </a></strong>
