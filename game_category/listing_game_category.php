                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-sm btn-primary mb-3'
                            href="../game_category/edit_game_category.php?id=<?php echo urlencode(openssl_encrypt($categories['id'], 'AES-128-ECB', 'your_secret_key')); ?>">Edit</a>

                        <a class='btn btn-sm btn-primary' href="../game_category/delete_game_category.php?id=<?php echo urlencode(openssl_encrypt($categories['id'], 'AES-128-ECB', 'your_secret_key')); ?>"
